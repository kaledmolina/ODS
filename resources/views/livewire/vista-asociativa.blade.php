...
@foreach ( $datosdos as $formulariodos )
        ...
        <div class="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            <div class="md:col-span-2 lg:col-span-1" >
                <div class="h-full py-8 px-6 space-y-6 rounded-xl border border-gray-200 bg-white">
                    ...
                    <div>
                        <h5 class="text-xl text-gray-600 text-center">Puntuacion mas alta Registrada</h5>
                        <div class="mt-2 flex justify-center gap-4">
                            <h3 class="text-3xl font-bold text-gray-700"> {{$formulariodos->puntuacionAlta}}0%</h3>
...
<path d="M6.00001 0L12 8H-3.05176e-05L6.00001 0Z" fill="currentColor"/>
                        ...
                        <span class="block text-center text-gray-500">Compara con la mas baja resgitrada {{$formulariodos->puntuacionBaja}}0%</span>
                    </div>
            ...
            <div>
                <div class="h-full py-6 px-6 rounded-xl border border-gray-200 bg-white">
                    <h5 class="text-xl text-gray-700">Puntuacion a mejorar</h5>
                    <div class="my-8">
                        <h1 class="text-5xl font-bold text-gray-800">{{$formulariodos->puntuacionBaja}}0%</h1>
                        <span class="text-gray-500">Compare con la mas alta {{$formulariodos->puntuacionAlta}}0%</span>
                    </div>
            ...
            <div>
                <div class="lg:h-full py-8 px-6 text-gray-600 rounded-xl border border-gray-200 bg-white">
                    ...
                    <div class="mt-6">
                        <h5 class="text-xl text-gray-700 text-center">Tu puntaje global de asociatividad</h5>
                        <div class="mt-2 flex justify-center gap-4">
                            <h3 class="text-3xl font-bold text-gray-700">{{$formulariodos->puntuacionGlobalAsociativa}}%</h3>
                            <div class="flex items-end gap-1 text-green-500">
                                <svg class="w-3" viewBox="0 0 12 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M6.00001 0L12 8H-3.05176e-05L6.00001 0Z" fill="currentColor"/>
                                </svg>
                        ...
                        <span class="block text-center text-gray-500">Establece una meta para mejorar</span>
                    </div>
    ...
    <div class="  h-full py-8 px-6 space-y-6">
                    <div class="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8 ">
                        ...
                        <table class="items-center w-full bg-transparent border-collapse">
                            <thead>
                                <tr>
                                    <th class="px-4 bg-gray-50 text-gray-700 align-middle py-3 text-xs font-semibold text-left uppercase border-l-0 border-r-0 whitespace-nowrap">Sección</th>
                                    <th class="px-4 bg-gray-50 text-gray-700 align-middle py-3 text-xs font-semibold text-left uppercase border-l-0 border-r-0 whitespace-nowrap">Porcentaje</th>
                                    <th class="px-4 bg-gray-50 text-gray-700 align-middle py-3 text-xs font-semibold text-left uppercase border-l-0 border-r-0 whitespace-nowrap min-w-140-px"></th>
                                </tr>
                            </thead>
                            <tbody class="divide-y divide-gray-100">
                                <tr class="text-gray-500">
                                    <th class="border-t-0 px-4 align-middle text-sm font-normal whitespace-nowrap p-4 text-left">Desarrollo de la asociatividad
                                    ...
                                    <div class="flex items-center">
                                        <span class="mr-2 text-xs font-medium">{{$formulariodos->puntuacionTotalasociatividad}}0%</span>
                                        <div class="relative w-full">
                                            <div class="w-full bg-gray-200 rounded-sm h-2">
                                                <div class="bg-cyan-600 h-2 rounded-sm" style="width: {{$formulariodos->puntuacionTotalasociatividad}}0%"></div>
                                            </div>
                                        </div>
                                    </div>
                                    </td>
                                ...
                                <tr class="text-gray-500">
                                    <th class="border-t-0 px-4 align-middle text-sm font-normal whitespace-nowrap p-4 text-left">Generación de trabajo, ingresos, calidad de vida</th>

                                    <td class="border-t-0 px-4 align-middle text-xs whitespace-nowrap p-4">
                                    <div class="flex items-center">
                                        <span class="mr-2 text-xs font-medium">{{$formulariodos->puntuacionFinalcalid}}0%</span>
                                        <div class="relative w-full">
                                            <div class="w-full bg-gray-200 rounded-sm h-2">
                                                <div class="bg-orange-300 h-2 rounded-sm" style="width:{{$formulariodos->puntuacionFinalcalid}}0%"></div>
                                            </div>
                                        </div>
                                    </div>
                                    </td>
                                ...
                                <tr class="text-gray-500">
                                    <th class="border-t-0 px-4 align-middle text-sm font-normal whitespace-nowrap p-4 text-left">Capacidad de gestion empresarial</th>

                                    <td class="border-t-0 px-4 align-middle text-xs whitespace-nowrap p-4">
                                    <div class="flex items-center">
                                        <span class="mr-2 text-xs font-medium">{{$formulariodos->puntuacionTotalCapacidad}}0%</span>
                                        <div class="relative w-full">
                                            <div class="w-full bg-gray-200 rounded-sm h-2">
                                                <div class="bg-teal-400 h-2 rounded-sm" style="width:{{$formulariodos->puntuacionTotalCapacidad}}0%"></div>
                                            </div>
                                        </div>
                                    </div>
                                    </td>
                                ...
                                <tr class="text-gray-500">
                                    <th class="border-t-0 px-4 align-middle text-sm font-normal whitespace-nowrap p-4 text-left">Capacidades de mercadeo</th>

                                    <td class="border-t-0 px-4 align-middle text-xs whitespace-nowrap p-4">
                                    <div class="flex items-center">
                                        <span class="mr-2 text-xs font-medium">{{$formulariodos->puntuacionTotalcapacidadmer}}0%</span>
                                        <div class="relative w-full">
                                            <div class="w-full bg-gray-200 rounded-sm h-2">
                                                <div class="bg-pink-600 h-2 rounded-sm" style="width:{{$formulariodos->puntuacionTotalcapacidadmer}}0%"></div>
                                            </div>
                                        </div>
                                    </div>
                                    </td>
                                ...
                                <tr class="text-gray-500">
                                    <th class="border-t-0 px-4 align-middle text-sm font-normal whitespace-nowrap p-4 text-left">Capacidades productivas</th>

                                    <td class="border-t-0 px-4 align-middle text-xs whitespace-nowrap p-4">
                                    <div class="flex items-center">
                                        <span class="mr-2 text-xs font-medium">{{$formulariodos->puntuacionTotalcapacidadprod}}0%</span>
                                        <div class="relative w-full">
                                            <div class="w-full bg-gray-200 rounded-sm h-2">
                                                <div class="bg-indigo-600 h-2 rounded-sm" style="width:{{$formulariodos->puntuacionTotalcapacidadprod}}0%"></div>
                                            </div>
                                        </div>
                                    </div>
                                    </td>
                                ...
                                <tr class="text-gray-500">
                                    <th class="border-t-0 align-middle text-sm font-normal whitespace-nowrap p-4 pb-0 text-left">Capacidades para el servicio</th>

                                    <td class="border-t-0 align-middle text-xs whitespace-nowrap p-4 pb-0">
                                    <div class="flex items-center">
                                        <span class="mr-2 text-xs font-medium">{{$formulariodos->puntuacionTotalcapacidadservi}}0%</span>
                                        <div class="relative w-full">
                                            <div class="w-full bg-gray-200 rounded-sm h-2">
                                                <div class="bg-purple-500 h-2 rounded-sm" style="width:{{$formulariodos->puntuacionTotalcapacidadservi}}0%"></div>
                                            </div>
                                        </div>
                                    </div>
                                    </td>
