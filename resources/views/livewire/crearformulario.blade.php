                                    ...
                                    @if ($currentPage === 1)
                                        <div class="flex flex-col">
                                            ...
                                            <div class="w-full py-2">
                                                ...
                                                <select wire:model.lazy="tipo_org" id="tipo_org" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 ">
                                    ...
                                    @elseif ($currentPage === 2)
                                        <div class="flex flex-col">
                                            <div class="w-full py-2">
                                                ...
                                                <select  wire:model.lazy="sect_economic" id="sect_economic" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 ">
                                                    <option  value="" class="select-none">--Seleccione--</option>
                                            ...
                                            <div class="w-full py-2">
                                                ...
                                                <select  wire:model.lazy="situac_geo" id="situac_geo" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 ">
                                                    <option value="" class="select-none">--Seleccione--</option>
                                                    <option>Rural</option>
                                            ...
                                            <div class="w-full py-2">
                                                ...
                                                <select  wire:model.lazy="ubic_geo" id="ubic_geo" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 ">
                                                    <option value="" class="select-none">--Seleccione--</option>
                                        ...
                                        <div class="flex flex-col">
                                            ...
                                            <div class="w-full py-2">
                                                ...
                                                <select wire:model.lazy="taman_org" id="taman_org" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 ">
                                                    <option value="" class="select-none">--Seleccione--</option>
                                                    <option>Micro</option>
                                            ...
                                            <div class="w-full py-2">
                                                ...
                                                <select wire:model.lazy="taman_num_org" id="taman_num_org" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                                                <option value="" class="select-none">--Seleccione--</option>
                                                <option>Micro</option>
                                                <option>Pequeño</option>
                                                <option>Mediano</option>
                                        ...
                                        <div class="w-full py-2">
                                            ...
                                            <input wire:model.lazy="empleados_h_org" type="number" name="empleados_h_org" id="empleados_h_org" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                                        ...
                                        <div class="w-full py-2">
                                            ...
                                            <input wire:model.lazy="empleados_f_org" type="number" name="empleados_f_org" id="empleados_f_org" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                                        ...
                                        @elseif ($currentPage === 7)
                                              ...
                                              <div class="w-full py-2">
                                                ...
                                                <select wire:model.lazy="pais" id="pais" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 ">
                                                <option  value="" class="select-none">--Seleccione--</option>
