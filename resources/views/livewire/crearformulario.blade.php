                                ...
                                <div class="px-4 py-5 bg-white sm:p-6">
                                    ...
                                    @if ($currentPage === 1)
                                        <div class="flex flex-col">
                                            ...
                                            <div class="w-full py-2">
                                                <label for="tipo_org" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">¿Qué tipo de organización social y solidaria es? (Por ejemplo, cooperativa, asociación, fundación, etc.)</label>
                                                <select wire:model.lazy="tipo_org" id="tipo_org" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                            ...
                                            <div class="w-full py-2">
                                                <label for="countries" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">¿Cuál es la actividad económica de la organización? (Usar los códigos CIIU del DANE para identificar la actividad principal de la organización).</label>
                                    ...
                                    @elseif ($currentPage === 2)
                                        <div class="flex flex-col">
                                            <div class="w-full py-2">
                                                <label for="sect_economic" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">¿En qué sector económico opera su organización?</label>
                                            ...
                                            <div class="w-full py-2">
                                                <label for="situac_geo" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">¿Situación geográfica de la organización?</label>
                                                <select  wire:model.lazy="situac_geo" id="situac_geo" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                                    <option value="" class="select-none">--Seleccione--</option>
                                                    <option>Rural</option>
                                            ...
                                            <div class="w-full py-2">
                                                <label for="ubic_geo" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">¿Cuál es la ubicación geográfica de la organización?</label>
                                                <select  wire:model.lazy="ubic_geo" id="ubic_geo" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                                    <option value="" class="select-none">--Seleccione--</option>
                                        ...
                                        <div class="flex flex-col">
                                            ...
                                            <div class="w-full py-2">
                                                <label for="taman_org" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">¿Determina el tamaño de la organización en función de sus activos totales? </label>
                                                <select wire:model.lazy="taman_org" id="taman_org" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                                    <option value="" class="select-none">--Seleccione--</option>
                                                    <option>Micro</option>
                                            ...
                                            <div class="w-full py-2">
                                                <label for="taman_num_org" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">¿Clasifica el tamaño de la organización en función del número de trabajadores que tiene?</label>
                                        ...
                                        <div class="w-full py-2">
                                            <label for="empleados_h_org" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">¿Cuál es el número actual de trabajadores hombres en la organización?</label>
                                        ...
                                        <div class="w-full py-2">
                                            <label for="empleados_f_org" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">¿Cuál es el número actual de trabajadoras mujer en la organización?</label>
                                        ...
                                        @elseif ($currentPage === 7)
                                              ...
                                              <div class="w-full py-2">
                                                ...
                                                <select wire:model.lazy="pais" id="pais" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                                <option  value="" class="select-none">--Seleccione--</option>
